            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <Link
                    to={feature.path}
                    className={`w-full py-3 px-6 rounded-lg bg-gradient-to-r ${feature.gradient} text-white font-medium hover:opacity-90 transition-opacity duration-200 block text-center`}
                  >
                    Get Started
                  </Link>
                </div>
